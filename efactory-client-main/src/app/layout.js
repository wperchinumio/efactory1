...
var Layout = function () {
    ...
    var getOuterHeight = function (selector) {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed')) {
                ...
                if (body.hasClass('page-footer-fixed') === false) {
                    height = height - getOuterHeight('.page-footer');
                }
            } else {
    ...
    //     }
    //     //------------------------
    //     // Walter (expand sidebar menu)
    //     //------------------------
    //     var attr = $('.page-sidebar-menu').attr('data-bound');
    //     if (!(attr  == undefined || attr == false)) return;
    //     $('.page-sidebar-menu').attr('data-bound',true);
    //     //------------------------
    ...
    //     var body = $('body');
    //     if (body.hasClass('page-sidebar-fixed')) {
    //         // if (body.hasClass('page-sidebar-closed')) {// CHANGED
    ...
    var handleSidebarToggler = function () {
        ...
        // Walter: remove previous click event handler in case you have already attached someone.
    ...
    var handle100HeightContent = function () {
        ...
        // Walter -----------------
        var height_note = App.getViewPort().height -
            $('.page-header').outerHeight(true) -
            $('.page-footer').outerHeight(true) -
            $('.page-title').outerHeight(true) -
            $('.page-bar').outerHeight(true) - 70;
        $('#area-note').css('min-height', height_note );
        $('#note-items').css('min-height', height_note - 55 );
        $('#note-items').slimScroll({
            height: height_note - 55 + 'px'
        });
    ...
    var handleAmchartsPrint = function() {
    
      var beforePrint = function() {
        for(var i = 0; i < AmCharts.charts.length; i++) {
          var chart = AmCharts.charts[i];
          chart.div.style.width = (chart.printWidth)? chart.printWidth: "700px";
          chart.validateNow();
        }
      };
        ...
        loadAjaxContent: function(url, sidebarMenuLink) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (sidebarMenuLink.size() > 0 && sidebarMenuLink.parents('li.open').length === 0) {
