...
const ShipConfirmActivity = props => {
  ...
  useEffect(
    () => {
      props.settingsActions.readShipConfirmActivity()
  ...
  function filterActivityRecords (ship_confirm_activity_records) {
    ...
    ship_confirm_activity_records = ship_confirm_activity_records.filter( aRecord => {
      ...
      total_shipments = String( total_shipments ).toLowerCase()
      ...
      switch ( true ) {
        ...
        case total_shipments.includes(filterValue_):
  ...
  function viewAck (event) {
    ...
    props.settingsActions.readShipConfirmAckData(id).then(
        ...
        <div className="portlet-title">
          ...
          <div className="actions">
            <button 
              ...
              onClick={props.settingsActions.readShipConfirmActivity}
            >
              ...
              <thead>
                <tr className="table-header-1 uppercase bg-dark">
                  ...
                  <th className="vertical-align-middle text-right" style={{ width: '150px' }}>
                    <span className="column-sort noprint"><i className={ classNames({
                      'fa fa-long-arrow-down' : true,
                      'active' : currentSortedField === 'total_shipments' && sortType === "ascending" ? true : false
                    }) } aria-hidden="true"></i></span>
                    <span className="column-sort column-sort-up noprint"><i className={ classNames({
                      'fa fa-long-arrow-up' : true,
                      'active' : currentSortedField === 'total_shipments' && sortType === "descending" ? true : false,
                    }) } aria-hidden="true"></i></span>
                    <a 
                      data-field="total_shipments"
                      onClick={ sort }
                    > 
                      TOTAL SHIPMENTS
                    </a>
                  </th>
                  <th className="vertical-align-middle text-center" style={{ width: '100px' }}>
                    <span className="column-sort noprint"><i className={ classNames({
                      'fa fa-long-arrow-down' : true,
