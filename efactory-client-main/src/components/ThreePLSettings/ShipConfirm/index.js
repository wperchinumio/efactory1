...
import OnDemand from '../ShipConfirmOnDemand'
import OnSchedule from '../ShipConfirmScheduler'
import Tabs from '../../_Shared/Components/Tabs'
import Activity from './Activity'
import ActivityDetail from './ActivityDetail'
import { getUserData } from '../../../util/storageHelperFuncs'

const ShipConfirmMain = props => {
...
ShipConfirmMain.propTypes = {
  threePLState: PropTypes.object.isRequired,
  settingsActions: PropTypes.object.isRequired
}

export default ShipConfirmMain