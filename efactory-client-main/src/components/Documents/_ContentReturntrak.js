...
import Config, { TreeviewConfig_Returntrak } from './_Config'
import Popup from '../_Shared/Popup';

const ReturntrakDocumentPageBody = ({
  checkedRows,
  documentActions,
  document_sort,
  error,
  ...
  return (
    <div>
      ...
      <MoveToModal
        ...
        TreeviewConfig={ TreeviewConfig_Returntrak }
        movedFile={movedFile}
