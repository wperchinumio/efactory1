      	...
      	<div className="col-md-5">
				...
				<div className="col-md-2 total-col">
				  {	
				  	!compareYears &&
		        <span>
					  	<span className="total-edge service-0">
				  ...
				  {	
				  	compareYears &&
		        <span>
						  <span className="total-edge service-0"> <b className="total">Total: &nbsp;</b> { formatNumber( total, 0 ) } </span>
						  <br/>
						  <span className="total-edge service-1"> <b className="total">Total (-1 y): &nbsp;</b> { formatNumber( total_1, 0 ) } </span>
						  <br/>
						  <span className="total-edge service-2"> <b className="total">Total (-2 y): &nbsp;</b> { formatNumber( total_2, 0 ) } </span>
						</span>
				  }
				</div>
    	</div>
