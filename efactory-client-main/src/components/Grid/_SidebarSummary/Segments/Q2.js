  ...
  return (
    <div className="portlet light order-summary">
      <div className="portlet-title">
        ...
        <div className="caption font-yellow-gold bold uppercase">Receiving</div>
      </div>
      <div className="portlet-body">
        <div className="row">
          <div className="col-md-5 seg-label">DCL Item #:</div>
          <div className="col-md-7">{ detail.dcl_item_no }</div>
        </div>
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-md-7">{ detail.order_desc }</div>
        </div>
        <div className="row">
        ...
        <div className="row">
          <div className="col-md-5 seg-label">R. Trans. Date:</div>
          <div className="col-md-7">{ formatDate(detail.tr_date)}</div>
        </div>
        <div className="row">
        ...
        <div className="row">
          <div className="col-md-5 seg-label">Ref. Trans. #:</div>
          <div className="col-md-7"> { detail.ref_tr_no } </div>
        </div>
        <div className="row">
          <div className="col-md-5 seg-label">Last Status:</div>
          <div className="col-md-7">{ detail.last_status }</div>
        </div>
        <div className="row">
          <div className="col-md-5 seg-label">Next Status:</div>
          <div className="col-md-7">{ detail.next_status }</div>
        </div>
      </div>
    </div>     
  )
