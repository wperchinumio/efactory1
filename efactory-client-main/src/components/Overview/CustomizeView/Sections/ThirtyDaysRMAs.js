...
const ThirtyDaysRMAs = props => {
  function onSwitchClicked (event) {
    ...
    current_areas = current_areas.map(
      area => ({
        ...area,
        visible : area.name === '30days_rmas' ? !area.visible : area.visible
      })
    )
    ...
    >
      <div className="portlet-title">
        <div className="caption caption-md">
          <span>Component:</span> &nbsp;
          <span className="customize-overview-title">30 DAYS RMA</span>
        </div>
