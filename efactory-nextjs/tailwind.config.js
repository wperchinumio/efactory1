  ...
  theme: {
  	extend: {
  		...
  		colors: {
  			...
  			'theme-green-dark': 'var(--theme-green-dark)',
  			'theme-green-light': 'var(--theme-green-light)',
  			'theme-green-soft': 'var(--theme-green-soft)',
  			'theme-green-soft-light': 'var(--theme-green-soft-light)',
