...
export default function SignInProfessional() {
  ...
  return (
    <div className="brand-dcl">
          ...
          <div className='flex flex-wrap items-center justify-between gap-10 sm:mb-30 mb-6'>
            <div className='form-check'>
              <input
                ...
                disabled={submitting}
              />
              <label className='form-check-label' htmlFor='remember1'>Remember me</label>
            </div>
            ...
            <div className='form-check'>
              <input
                ...
                disabled={submitting}
              />
              <label className='form-check-label' htmlFor='dcl_user1'>DCL User</label>
            </div>
      ...
      <div className='text-center sm:mt-30 mt-6'>
        <Link href='/auth/sign-in' className='text-font-color-100 hover:text-primary transition-colors'>
          Prefer the standard sign-in?
        </Link>
      </div>
    </div>
  )
